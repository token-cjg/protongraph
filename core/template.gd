...
var _proxy_nodes := {}
var _remote_inputs := {}
var _remote_resources := {} # This should probably be stored by a lookup key per remote procgen request in a database, as this might be globally shared amongst all requests to Protongraph at present
